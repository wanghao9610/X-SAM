...
s2_pretrained_pth = (
    work_dir
    + "s2_train/xsam_phi3_mini_4k_instruct_siglip2_so400m_p14_384_sam_vit_large_e1_gpu16/pytorch_model.bin"
)  # noqa: E501
...
image_token = "<image>"  # default <image> token for Phi-3 + SigLIP
...
use_placeholder = False  # Qwen-style placeholder expansion is not needed for SigLIP
