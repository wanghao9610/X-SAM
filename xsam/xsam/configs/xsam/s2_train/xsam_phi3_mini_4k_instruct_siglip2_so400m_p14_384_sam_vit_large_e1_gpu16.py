...
from xsam.dataset import ImgChatDataset
from xsam.dataset.collate_fns import xsam_collate_fn
from xsam.dataset.map_fns import img_chat_map_fn, template_map_fn_factory
...
SYSTEM = ""
generation_images = code_dir + "xsam/configs/xsam/samples/sample.jpg"
