...
# modified from transformers.models.qwen3.modeling_qwen3.Qwen3Attention.forward
...
def qwen3_attn_forward(
    ...
    **kwargs: Unpack[FlashAttentionKwargs],
    ...
    # Qwen3 applies q_norm and k_norm after q_proj and k_proj
    ...
    # different from Qwen3Attention.forward
    ...
    attn_output, attn_weights = attention_interface(
        ...
        sliding_window=self.sliding_window,  # Qwen3 uses self.sliding_window directly
        **kwargs,
    )
